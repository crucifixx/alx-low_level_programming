...
```
The problem of distinguishing prime numbers fgcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c 101-main.c 101-print_number.c -o 101-print_numbersrom composite numbers and of
